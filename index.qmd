...
![](multiple_simulations_distribution.png){fig-cap="Distribution of final account balances from 100 simulations (ages 25–55) with OO matplotlib"}
...
**Commentary:** Am I happy? No—this is deeply concerning. While the mean suggests profitability, the median reveals the harsh reality: most people lose money. The distribution is heavily right-skewed with extreme volatility (std dev = $6,574). This demonstrates the ergodicity problem: mathematical expectation is positive, but typical individual outcomes are devastating. The 31% success rate means 69% of people face financial ruin, highlighting why simulation is crucial for understanding real-world risk.
...
![](modified_strategy_distribution.png){fig-cap="Distribution of final account balances from 100 simulations of modified strategy (50% betting) with OO matplotlib"}
